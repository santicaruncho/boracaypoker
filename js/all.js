(function($){
    ...
    function init_shortcodes(){
        ...
        $(".accordion").each(function(){
            ...
            $(this).hide("dd").first().slideDown("easeOutExpo");
...
$(document).ready(function(){
    ...
    //   $('.dd-content').addClass('ddc-hide');
    // });
    // $('.btn-price').click(function(){
    //   $('.dd-price').toggleClass('ddc-hide');
    // });
    // $('.btn-beds').click(function(){
    //   $('.dd-beds').toggleClass('ddc-hide');
    // });
    // $('.btn-type').click(function(){
    //   $('.dd-type').toggleClass('ddc-hide');
    // });
    // $('.btn-more').click(function(){
    //   $('.dd-more').toggleClass('ddc-hide');
    // });
    $('.btn-dd').click(function(){
      // $('.dd-content').addClass('ddc-hide');
